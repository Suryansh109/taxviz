        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4 p-4 bg-gray-50 rounded-lg">
              ...
              <div className="space-y-4">
                <div className="flex flex-col">
                  <label htmlFor="salary" className="text-sm font-medium text-gray-700 mb-1">
                    Salary
                  </label>
                  <input
                    id="salary"
                ...
                <div className="flex flex-col">
                  <label htmlFor="tds" className="text-sm font-medium text-gray-700 mb-1">
                    TDS Deducted
                  </label>
                  <input
                    id="tds"
            ...
            <div className="space-y-4 p-4 bg-gray-50 rounded-lg">
              ...
              <div className="space-y-4">
                <div className="flex flex-col">
                  <label htmlFor="businessIncome" className="text-sm font-medium text-gray-700 mb-1">
                    Business Income
                  </label>
                  <input
                    id="businessIncome"
                    ...
                    onChange={handleInputChange}
                    className={`border rounded-md p-2 text-gray-900 bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${
                      errors.businessIncome ? 'border-red-500' : 'border-gray-300'
                    }`}
                    placeholder="0"
                  />
                ...
                <div className="flex flex-col">
                  <label htmlFor="rentalIncome" className="text-sm font-medium text-gray-700 mb-1">
                    Rental Income
                  </label>
                  <input
                    id="rentalIncome"
                ...
                <div className="flex flex-col">
                  <label htmlFor="otherIncome" className="text-sm font-medium text-gray-700 mb-1">
                    Other Income
                  </label>
                  <input
                    id="otherIncome"
